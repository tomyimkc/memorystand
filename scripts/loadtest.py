...
SEED_SOURCE_TAG = "standing-loadtest"
...
def write_report(
    ...
    embed_desc = (
        ...
        else "deterministic local stub (STANDING_EMBED_STUB=1, no AWS account used)"
    )

    body = f"""# Standing -- retrieval load test results
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument("--dsn", default=None, help="override STANDING_DSN/COCKROACH_DSN for this run")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.dsn:
        os.environ["STANDING_DSN"] = args.dsn
    ...
    print("=" * 70)
    print("Standing -- retrieval load test (vector-indexed vs. brute-force)")
    print("=" * 70)
    print(
